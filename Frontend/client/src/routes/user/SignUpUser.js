...
const SignUpUser = () => {
  return (
    <div className="w-screen min-w-[350px] h-screen flex justify-evenly items-center bg-[#0F171A]">
      <div className="w-[45vw] min-w-[350px] flex flex-col justify-center items-center text-white py-[20px]">
        ...
        <h2 className="text-center text-[20px]">Create Your Account</h2>
        ...
        <h3 className="text-center text-[15px] mt-[40px]">
          ...
          <Link className="text-[#8499f8] font-black" to="/">
            Login
          </Link>
        </h3>
      </div>
