...
import { handleUpdateEmployee } from "../../../controller/handleUpdateEmployee";
import { useState } from "react";
import { IoClose } from "react-icons/io5";

const UpdateEmployee = ({ onClose, ...props }) => {
  ...
  return (
    <div className="w-[90%] min-w-[310px] md:w-[500px] h-[500px] bg-[#1A262D] rounded-[15px] pt-0 p-[10px]">
      ...
      <div className="h-[440px] overflow-y-scroll flex flex-col items-center p-[10px]">
        <h2 className="text-[14px] text-[#AEB0AF]">Update Employee Details</h2>
